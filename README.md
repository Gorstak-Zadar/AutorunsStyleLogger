...
> **Autoruns-Compatible Logger** - Creates startup monitoring logs compatible with Autoruns format.

---

## 📋 Overview

AutorunsStyleLogger creates startup and persistence logs in a format compatible with Sysinternals Autoruns for easy analysis and comparison.

---

## 🎯 Purpose

- 📝 **Startup Logging** - Log all startup locations
- 🔄 **Format Compatibility** - Autoruns-compatible output
- 📊 **Baseline Creation** - Create system baselines
- 🔍 **Comparison Ready** - Easy diff analysis
...
```powershell
# Create Autoruns-style log
.\AutorunsStyleLogger.ps1
```
